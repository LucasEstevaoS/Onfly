        ...
        <div class="relative flex items-top justify-center min-h-screen bg-gray-100 dark:bg-gray-900 sm:items-center py-4 sm:pt-0">
            @if (Route::has('login'))
                <div class="hidden fixed top-0 right-0 px-6 py-4 sm:block">
                    @auth
                        <a href="{{ url('/despesas') }}" class="text-sm text-gray-700 underline">Despesas</a>
                        <!-- /despesas isso levara pulara o deashboard na primeira pagina inicial-->
                    @else
            ...
            <div class="ml-4 text-center text-sm text-black-500 sm:text-left sm:ml-0">
                <h1>Aplicação Web proposto como desafio da empresa Onfly:</h1><br>
                    CRUD de uma aplicação de despesas <br>
                    Validação de usuario<br>
                <br>
                <br>
                Desenvolvido por Lucas Estevao
            </div>
